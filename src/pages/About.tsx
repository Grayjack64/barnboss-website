  ...
  const teamMembers = [
    {
      ...
      role: 'Co-Founder & CEO',
      bio: 'NCHA Non-Pro Hall of Fame inductee and two-time NCHA Eastern National Champion from Corinth, Mississippi. MJ owns Belle Terre Ranch with her husband Vick and has won multiple futurity championships including the Brazos Bash, Southern Cutting Futurity, and Augusta Futurity. Her real-world experience managing champion horses, coordinating workers, and running complex stable operations inspired the creation of BarnBoss.',
